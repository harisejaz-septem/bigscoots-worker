/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a4ac1795440db32df712213175072574)
// Runtime types generated with workerd@1.20250917.0 2025-09-22 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NonceReplayGuard";
	}
	interface Env {
		KV: KVNamespace;
		AUTH0_ISSUER: "http://auth.scoots-test.com/";
		AUTH0_AUDIENCE: "http://auth.scoots-test.com/api/v2/";
		JWKS_URL: "http://auth.scoots-test.com/.well-known/jwks.json";
		USER_SERVICE_URL: "https://v2-user.bigscoots.dev";
		SITE_SERVICE_URL: "https://v2-sites.bigscoots.dev";
		NONCE_TRACKER: DurableObjectNamespace<import("./src/index").NonceReplayGuard>;
	}
}
